    ...
    <body onload="buscarUser(<?php echo $id;?>)">
        ...
        <div class="vertical-nav nav-edit" id="verticalNav">
            ...
            <div class="justify-content-center text-center">
                <button type="button" id="projetos" class="btn signin">Projetos</button>
                <button type="button" id="concluidos" class="btn signin">Concluídos</button>
                <button type="button" style="font-size: 16px;" id="em_andamento" class="btn signin">Em andamento</button>
